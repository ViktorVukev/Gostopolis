import {Component, ElementRef, ViewChild, inject, NgZone, Inject, OnInit} from '@angular/core';
...
export class GeneralInformationDialogComponent implements OnInit {
  ...
  update(): void {
    ...
    this.restaurantService.update(this.restaurant.id, this.updateForm.value).subscribe(() => {
